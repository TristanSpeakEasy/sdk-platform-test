...
func CreateGetUnionErrorsResponseBodyTag1(tag1 TaggedError1) GetUnionErrorsResponseBody {
...
func CreateGetUnionErrorsResponseBodyTag2(tag2 TaggedError2) GetUnionErrorsResponseBody {
...
func (u *GetUnionErrorsResponseBody) UnmarshalJSON(data []byte) error {
	...
	case "tag1":
		...
		if err := utils.UnmarshalJSON(data, &taggedError1, "", true, false); err != nil {
			return fmt.Errorf("could not unmarshal `%s` into expected (Tag == tag1) type TaggedError1 within GetUnionErrorsResponseBody: %w", string(data), err)
		}
	...
	case "tag2":
		...
		if err := utils.UnmarshalJSON(data, &taggedError2, "", true, false); err != nil {
			return fmt.Errorf("could not unmarshal `%s` into expected (Tag == tag2) type TaggedError2 within GetUnionErrorsResponseBody: %w", string(data), err)
		}
...
func CreateGetUnionErrorsResponseResponseBodyErrorType1(errorType1 ErrorType1) GetUnionErrorsResponseResponseBody {
...
func CreateGetUnionErrorsResponseResponseBodyErrorType2(errorType2 ErrorType2) GetUnionErrorsResponseResponseBody {
